    ...
    <header className="flex items-center justify-between bg-transparent px-4 py-3 shadow-sm dark:bg-gray-950">
      ...
      <div className="flex items-center gap-6 text-sm font-medium">
        ...
        <Button
          ...
          className="ml-6 inline-flex h-8 items-center justify-center rounded-md bg-gray-900 px-4 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
        >
